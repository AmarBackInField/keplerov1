...
async def entrypoint(ctx: agents.JobContext):
    ...
    try:
        ...
        min_speech_duration=0.1,      # Reduce from ~0.5s to 0.1s
        min_silence_duration=0.3,      # How long to wait after speech stops
        activation_threshold=0.5,      # Speech confidence threshold (0-1)
        sample_rate=16000
